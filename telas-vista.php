...
<script language="JavaScript">
      function pregunta(e){
          if (confirm('¿Estas seguro de que deseas eliminar esta tela?.')){
...
<br>
    <div class="container">
        ...
        if(isset($_GET['action']) == 'delete'){
            $id_delete = intval($_GET['ID_Tela']);
            $query = mysqli_query($conn, "SELECT * FROM tela WHERE ID_Tela='$id_delete'");
            if(mysqli_num_rows($query) == 0){
                echo '<div class="alert alert-success alert-dismissable"><button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button> No se encontraron datos.</div>';
            }else{
                $delete = mysqli_query($conn, "DELETE FROM tela WHERE ID_Tela='$id_delete'");
                if($delete){
        ...
        <div class="panel panel-default">
            <div class="panel-heading">
                <h3 class="panel-title" align="center"></i> Telas</h3>
			</div>
			<div class="panel-body">
               <div class="pull-left">
                ...
                <div class="pull-right">
                    <a href="registro-tela.php" class="btn btn-sm btn-primary"><span class="icon icon-plus"></span><br>Nueva Tela</a>
                </div><br><br>
                <hr>
                <table id="lookup" class="table table-bordered table-hover">
                    ...
                    <tr>
                        ...
                        <th class="text-center" style="text-align: center;"> Caracteristicas </th>
    ...
    $(document).ready(function() {
            var dataTable = $('#lookup').DataTable( {
             ...
             "language":	{
                ...
                "serverSide": true,
                "ajax":{
                    url :"ajax-grid-data-tela-vista.php", // json datasource
