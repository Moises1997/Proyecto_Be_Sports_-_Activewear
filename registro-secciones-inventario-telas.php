...
if(isset($_POST['input'])){
    ...
    $sql="INSERT INTO seccion_tela(ID_Seccion, Nombre_seccion) VALUES ('NULL', '$Seccion')";

    $verificar_seccion = mysqli_query($conn, "SELECT * FROM seccion_tela WHERE Nombre_seccion = '$Seccion'");
...
<div class="panel panel-default">
    ...
    <div class="panel-body">
        <hr>
            <form class="form-horizontal row-fluid" action="registro-secciones-inventario-telas.php" method="post" enctype="multipart/form-data" style="text-align: center;">
