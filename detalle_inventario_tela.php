...
<br>
    <div class="container">
        ...
        if(isset($_GET['action']) == 'delete'){
            $id_delete = intval($_GET['ID_Inventario']);
            $query = mysqli_query($conn, "SELECT * FROM inventario_tela WHERE ID_Inventario='$id_delete'");
            if(mysqli_num_rows($query) == 0){
                echo '<div class="alert alert-success alert-dismissable"><button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button> No se encontraron datos.</div>';
            }else{
                $delete = mysqli_query($conn, "DELETE FROM inventario_tela WHERE ID_Inventario='$id_delete'");
                if($delete){
        ...
        <div class="panel panel-default">
            <div class="panel-heading">
                <h3 class="panel-title" align="center"></i>Inventario de Telas</h3>
			</div>
			<div class="panel-body">
               <div class="pull-left">
                ...
                <div class="pull-right">
                    <a href="registro-adquisicion-inventario.php" class="btn btn-sm btn-primary"><span class="icon icon-plus"></span><br>Nueva Adquisicion</a>
                </div><br><br>
                <hr>
                <table id="lookup" class="table table-bordered table-hover">
                    <thead bgcolor="#eeeeee" align="center">
                    <tr>
                        <th style="text-align: center;">Nombre tela</th>
                        <th style="text-align: center;">Color</th>
                        <th class="text-center" style="text-align: center;">Sección</th>
                        <th class="text-center" style="text-align:center;">Peso</th>
    ...
    $(document).ready(function() {
            var dataTable = $('#lookup').DataTable( {
             ...
             "language":	{
                ...
                "serverSide": true,
                "ajax":{
                    url :"ajax-grid-data-detalle-inventario.php", // json datasource
