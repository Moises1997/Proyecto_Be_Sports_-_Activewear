                ...
                if ($_SESSION["Privilegio"] == 5){
                    ...
                    if ($_SESSION["Privilegio"] == 1){
                        ...
                        if ($_SESSION["Privilegio"] == 6){
                            header("location: menu_empleados_corte.php");
                        }else{
        ...
        <center>
          ...
          <div class="media-body">
			...
			<div class="container" style="text-align:center;">
				...
				<span class="label label-info" style="font-size: 0.8em;"><?php echo $_SESSION["Privilegio"] == 1 ? 'Administrador' : 'Empleado(a) de Confección'; ?></span><br>
            ...
            <center>
                ...
                <div class="tab-content" id="myTabContent">
                  <div class="tab-pane fade show active" id="usuarios" role="tabpanel" aria-labelledby="usuarios-tab">
                    <a class="btn btn-primary" href="detalle_nomina_empleados.php" role="button"><img src="bootstrap/png/banker.png" alt="" class="mr-2"><hr><h6>Mis<br>Nóminas</h6></a>
