...
<div class="container">
    <?php
        ...
        $sql = mysqli_query($conn, "SELECT * FROM seccion_almacen WHERE ID_Seccion='$idseccion'");
        if(mysqli_num_rows($sql) == 0){
            header("Location: secciones_almacen.php");
        }else{
        ...
        if(isset($_POST['update'])){
            ...
            $update = "UPDATE seccion_almacen SET ID_Seccion='$idseccion', Nombre_seccion='$Seccion' WHERE ID_Seccion='$idseccion'";
