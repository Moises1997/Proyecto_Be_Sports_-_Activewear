...
<main role="main" class="flex-shrink-0">
    ...
    <div class="container" style="text-align:center;">
        ...
        <span class="label label-info" style="font-size: 0.8em;"><?php echo $_SESSION["Privilegio"] == 1 ? 'Administrador' : 'Encargado(a)<br> Area de Almacén'; ?></span><br>
    ...
    <div class="tab-content" id="myTabContent">
        <div class="tab-pane fade show active" id="almacen" role="tabpanel" aria-labelledby="almacen-tab">
            ...
            <a class="btn btn-primary" href="detalle_inventario_almacen.php" role="button"><img src="bootstrap/png/packing-2.png" alt="" class="mr-2"><hr><h6>Gestion<br>de Inventario</h6></a>
