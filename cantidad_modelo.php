        ...
        <div class="panel panel-default">
			...
			<div class="panel-body">
                ...
                <div class="pull-right">
				    <a href="registro-cantidad.php" class="btn btn-sm btn-primary"><span class="icon icon-plus" st></span><br>Nueva Cantidad</a>
                </div><br><br>
                <hr>
        ...
        $(document).ready(function() {
				var dataTable = $('#lookup').DataTable( {
				 ...
				 "language":	{
					...
					"serverSide": true,
					"ajax":{
						url :"ajax-grid-data-cantidad.php", // json datasource
