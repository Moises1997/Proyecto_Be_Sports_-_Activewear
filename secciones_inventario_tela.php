...
<br>
    <div class="container">
        ...
        if(isset($_GET['action']) == 'delete'){
            ...
            $query = mysqli_query($conn, "SELECT * FROM seccion_tela WHERE ID_Seccion='$id_delete'");
            if(mysqli_num_rows($query) == 0){
                echo '<div class="alert alert-success alert-dismissable"><button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button> No se encontraron datos.</div>';
            }else{
                $delete = mysqli_query($conn, "DELETE FROM seccion_tela WHERE ID_Seccion='$id_delete'");
                if($delete){
        ...
        <div class="panel panel-default">
            <div class="panel-heading">
                <h3 class="panel-title" align="center"></i>Secciones del Inventario de Telas</h3>
			</div>
			<div class="panel-body">
               <div class="pull-left">
                ...
                <div class="pull-right">
                    <a href="registro-secciones-inventario-telas.php" class="btn btn-sm btn-primary"><span class="icon icon-plus"></span><br>Nueva Sección</a>
                </div><br><br>
                <hr>
    ...
    $(document).ready(function() {
            var dataTable = $('#lookup').DataTable( {
             ...
             "language":	{
                ...
                "serverSide": true,
                "ajax":{
                    url :"ajax-grid-data-secciones-inventario.php", // json datasource
